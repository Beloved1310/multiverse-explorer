 ...
 *
 * Filters change the list's URL via `router.replace` (see
 * useCharacterFilters), which never adds a history entry, so whatever
 * search/filter state was active is still sitting in the one history
 * entry this goes back to -- nothing extra to preserve on this end.
 */
